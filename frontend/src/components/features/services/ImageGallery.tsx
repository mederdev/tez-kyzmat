  ...
  return (
    <div className="space-y-2">
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="max-w-[95vw] sm:max-w-3xl md:max-w-4xl lg:max-w-6xl w-full h-[90vh] sm:h-[85vh] p-0 bg-white">
          <div className="relative h-full flex items-center justify-center bg-gray-100">
            ...
            <img
              ...
              className="max-h-[85vh] sm:max-h-[80vh] w-[80%] object-contain"
            />
